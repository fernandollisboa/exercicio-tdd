...
public class CalculadoraTest {
    ...
    public void testCalculaSalarioLiquidoDesenvolvedorAbaixoDe3000() {
        Funcionario funcionario = new Funcionario("Fernando", "fernando@email.com", 2999.00, "DESENVOLVEDOR");
    ...
    public void testCalculaSalarioLiquidoDesenvolvedorAcimaDe3000() {
        Funcionario funcionario = new Funcionario("Fernando", "fernando@email.com", 3001.00, "DESENVOLVEDOR");
        double salarioLiquido = calculadora.calculaSalarioLiquido(funcionario);
    ...
    public void testCalculaSalarioLiquidoDesenvolvedorIgualA3000() {
        Funcionario funcionario = new Funcionario("Fernando", "fernando@email.com", 3000.00, "DESENVOLVEDOR");
        double salarioEsperado = funcionario.getSalarioBase() * 0.8;
        double salarioLiquido = calculadora.calculaSalarioLiquido(funcionario);
        assertEquals(salarioEsperado, salarioLiquido, 0.1);
    }
    ...
    public void testCalculaSalarioLiquidoDBAAbaixoDe2000() {
        Funcionario funcionario = new Funcionario("Fernando", "fernando@email.com", 1999.00, "DBA");
    ...
    public void testCalculaSalarioLiquidoDBAAcimaDe2000() {
        Funcionario funcionario = new Funcionario("Fernando", "fernando@email.com", 2001.00, "DBA");
    ...
    public void testCalculaSalarioLiquidoDBAIgualA2000() {
        Funcionario funcionario = new Funcionario("Fernando", "fernando@email.com", 2000.00, "DBA");
        double salarioEsperado = funcionario.getSalarioBase() * 0.75;
        double salarioLiquido = calculadora.calculaSalarioLiquido(funcionario);
        assertEquals(salarioEsperado, salarioLiquido, 0.1);
    }
    ...
    public void testCalculaSalarioLiquidoTestadorAbaixoDe2000() {
        Funcionario funcionario = new Funcionario("Fernando", "fernando@email.com", 1999.00, "TESTADOR");
        double salarioEsperado = funcionario.getSalarioBase() * 0.85;
        double salarioLiquido = calculadora.calculaSalarioLiquido(funcionario);
        assertEquals(salarioEsperado, salarioLiquido, 0.1);
    }
    ...
    public void testCalculaSalarioLiquidoTestadorAcimaDe2000() {
        Funcionario funcionario = new Funcionario("Fernando", "fernando@email.com", 2001.00, "TESTADOR");
        double salarioEsperado = funcionario.getSalarioBase() * 0.75;
        double salarioLiquido = calculadora.calculaSalarioLiquido(funcionario);
        assertEquals(salarioEsperado, salarioLiquido, 0.1);
    }
    ...
    public void testCalculaSalarioLiquidoTestadorIgualA2000() {
        Funcionario funcionario = new Funcionario("Fernando", "fernando@email.com", 2000.00, "TESTADOR");
        double salarioEsperado = funcionario.getSalarioBase() * 0.75;
        double salarioLiquido = calculadora.calculaSalarioLiquido(funcionario);
        assertEquals(salarioEsperado, salarioLiquido, 0.1);
    }
    ...
    public void testCalculaSalarioLiquidoGerenteAbaixoDe5000() {
        Funcionario funcionario = new Funcionario("Fernando", "fernando@email.com", 4999.00, "GERENTE");
        double salarioEsperado = funcionario.getSalarioBase() * 0.8;
        double salarioLiquido = calculadora.calculaSalarioLiquido(funcionario);
        assertEquals(salarioEsperado, salarioLiquido, 0.1);
    }
    ...
    public void testCalculaSalarioLiquidoGerenteAcimaDe5000() {
        Funcionario funcionario = new Funcionario("Fernando", "fernando@email.com", 5001.00, "GERENTE");
